<?php
  ...
  ?>
          <div class="col-xl-3 col-md-6 mb-4">
            <div class="card border-left-info shadow h-100 py-2">
              <form method="POST"><label class="btn-trash" for="copiadodocumentodoimovel"><i class="fas fa-times"></i></label><input type="submit" id="copiadodocumentodoimovel" name="copiadodocumentodoimovel<?php echo $omsid; ?>" hidden></form>
  ...
  <?php
          if(isset($_POST['copiadodocumentodoimovel'.$omsid])) {
            unlink($omsfile);
